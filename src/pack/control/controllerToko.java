...
//menghapus data yang dipilih
    public void Hapus(){
        if (!hm.getTxtKodee().getText().trim().isEmpty()){
            
        }else{
            String kodee = (hm.getTxtKodee().getText());
            impToko.HapusData(kodee);
    ...
    public void SimpanData(){
        ...
        toko.setkode(hm.getTxtKodee().getText());
    ...
    hm.getTxtKodee().setText(lt.get(row).getkode().toString());
